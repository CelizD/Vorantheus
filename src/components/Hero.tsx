    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 pt-40 pb-28">
        ...
        <motion.h1
          ...
          className="mt-10 text-[clamp(3rem,8vw,6.5rem)] font-black text-[#1C1B18] leading-[1.02] max-w-4xl"
        ...
        <motion.p
          ...
          className="mt-8 text-lg sm:text-xl text-[#6B6860] leading-relaxed max-w-xl"
        >
        ...
        <motion.div
          ...
          className="mt-20 pt-8 border-t border-[#E6E0D6] flex flex-wrap gap-x-12 gap-y-6"
        >
          {stats.map((s) => (
