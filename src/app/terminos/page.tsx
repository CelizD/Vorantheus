      ...
      <section className="section-light pt-36 pb-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-black/[0.06] shadow-card flex flex-col gap-10">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">1. Definiciones</h2>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.term} className="flex gap-3">
                    <span className="text-[#0071E3] font-semibold text-sm shrink-0 mt-0.5 w-24">{item.term}:</span>
                    <span className="text-muted text-sm leading-relaxed">{item.def}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">2. Alcance de los Servicios</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">3. Cotizaciones y Precios</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">4. Condiciones de Pago</h2>
              <div className="rounded-2xl bg-smoke border border-black/[0.06] p-6 mb-4">
                <h3 className="text-ink font-semibold mb-3">Esquema estándar de pagos:</h3>
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <div key={step.cuando} className="flex items-center gap-4">
                      <span className="text-[#0071E3] font-black text-lg w-12 shrink-0">{step.pct}</span>
                      <div>
                        <p className="text-ink text-sm font-medium">{step.cuando}</p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">5. Revisiones y Cambios</h2>
              <ul className="space-y-2">
                {[
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">6. Propiedad Intelectual</h2>
              <p className="text-muted leading-relaxed mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">7. Confidencialidad</h2>
              <p className="text-muted leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">8. Plazos y Entrega</h2>
              <ul className="space-y-2">
                {[
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">9. Garantía y Soporte</h2>
              <p className="text-muted leading-relaxed mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">10. Limitación de Responsabilidad</h2>
              <p className="text-muted leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">11. Terminación del Contrato</h2>
              <p className="text-muted leading-relaxed mb-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">12. Ley Aplicable y Jurisdicción</h2>
              <p className="text-muted leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold text-ink mb-4">13. Disposiciones Generales</h2>
              <ul className="space-y-2">
                {[
            ...
            <div className="border-t border-black/[0.08] pt-6">
              ...
              <p className="text-muted text-sm mt-3">
                Contacto legal:{' '}
                <a href={`mailto:${siteConfig.legalEmail}`} className="text-[#0071E3] hover:text-ink transition-colors">
