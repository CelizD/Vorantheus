        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="glass-card rounded-3xl p-8 sm:p-12 border border-white/10 flex flex-col gap-10">
            <div className="prose-dark">
              <h2 className="text-2xl font-bold text-white mb-4">1. Identificación del Responsable</h2>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2 text-voGray">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">3. Finalidades del Tratamiento</h2>
              <p className="text-voGray leading-relaxed mb-4">
                Sus datos personales son utilizados para las siguientes finalidades:
              </p>
              <div className="space-y-4">
                <div>
                  <h3 className="text-white font-semibold mb-2">Finalidades necesarias:</h3>
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={item} className="flex items-start gap-2 text-voGray text-sm">
                ...
                <div>
                  <h3 className="text-white font-semibold mb-2">Finalidades secundarias (con consentimiento):</h3>
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={item} className="flex items-start gap-2 text-voGray text-sm">
                        <span className="text-voGray/50 mt-0.5 shrink-0">○</span>
                        {item}
                      </li>
                    ))}
                  </ul>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">4. Transferencia de Datos</h2>
              <p className="text-voGray leading-relaxed mb-4">
              ...
              <p className="text-voGray leading-relaxed mt-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">5. Derechos ARCO</h2>
              <p className="text-voGray leading-relaxed mb-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    ...
                    <div>
                      <p className="text-white font-semibold text-sm">{item.derecho}</p>
                      <p className="text-voGray text-xs">{item.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
